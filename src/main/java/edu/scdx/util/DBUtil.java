        ...
        try {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                try {
                    ...
                    sql2 = "CREATE TABLE IF NOT EXISTS `server_performance` ( `project_id` int(11) DEFAULT NULL COMMENT '用户项目唯一id', `time_min` varchar(128) DEFAULT NULL COMMENT '采集时间，分钟粒度', `if_cpu_need_warn` varchar(128) DEFAULT NULL, `if_mem_need_warn` varchar(128) DEFAULT NULL, `if_disk_need_warn` varchar(128) DEFAULT NULL, `cpu_warn_num` double DEFAULT NULL, `mem_warn_num` double DEFAULT NULL, `disk_warn_num` double DEFAULT NULL, `cpu_usage` double DEFAULT NULL, `mem_usage` double DEFAULT NULL, `disk_usage` double DEFAULT NULL, `if_cpu_warned` varchar(128) DEFAULT NULL, `if_mem_warned` varchar(128) DEFAULT NULL, `if_disk_warned` varchar(128) DEFAULT NULL ) ENGINE = InnoDB CHARSET = utf8 COMMENT '用户服务器性能表'";
                    sql3 = "CREATE TABLE IF NOT EXISTS `time_cost` ( `project_id` int(11) DEFAULT NULL COMMENT '用户项目唯一id', `method_id` int(11) DEFAULT NULL COMMENT '用户项目方法唯一id', `class_name` varchar(128) DEFAULT NULL COMMENT '用户方法所在类全路径', `method_name` varchar(128) DEFAULT NULL COMMENT '用户方法名', `start_nano_time` bigint(20) DEFAULT NULL COMMENT '用户方法被调用纳秒值', `start_user_time` varchar(128) DEFAULT NULL COMMENT '用户方法被调用时间，粒度为秒', `end_nano_time` bigint(20) DEFAULT NULL COMMENT '用户方法调用结束纳秒值', `if_cost_need_warn` varchar(128) DEFAULT 'no', `cost_warn_num` int(11) DEFAULT '0', `cost` int(11) DEFAULT NULL COMMENT '用户方法耗时，单位为毫秒', `if_warned` varchar(128) DEFAULT NULL COMMENT '是否报警，yes/no' ) ENGINE = InnoDB CHARSET = utf8 COMMENT '用户API接口响应时间表'";
