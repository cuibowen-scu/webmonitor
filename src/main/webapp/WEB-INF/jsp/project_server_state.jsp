...
<ul class="hList">
    ...
    <li>
        <a href="/cost/getCostProject.do" class="menu">
            <h2 class="menu-title menu-title_2nd" style="width: 203px;">api cost</h2>
    ...
    <li>
        <a class="menu">
            <h2 class="menu-title menu-title_6th" style="width: 203px;">data access</h2>
            <ul class="menu-dropdown">
    ...
    <li>
        <a class="menu">
            <h2 class="menu-title menu-title_4th" style="width: 203px;">alarm history</h2>
            <ul class="menu-dropdown">
                <li id="api">api</li>
    ...
    <li>
        <a href="/offline/getOfflineProject.do" class="menu">
            <h2 class="menu-title menu-title_5th" style="width: 203px;">offline param</h2>
            <ul class="menu-dropdown">
            </ul>
        </a>
    </li>
    ...
    <li>
        <a class="menu">
            <h2 class="menu-title menu-title_3rd" style="width: 203px;">server state</h2>
            <ul class="menu-dropdown">
    ...
    <li>
        <a href="/project/getProjectList.do" class="menu">
            <h2 class="menu-title-home" style="width: 203px;">Project</h2>
            <ul class="menu-dropdown">
            </ul>
        </a>
    </li>
    ...
    <li>
        <a class="menu">
            <h2 class="menu-title menu-title_7th" style="width: 203px;">Account</h2>
            <ul class="menu-dropdown">
