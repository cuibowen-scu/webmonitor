...
<div class="container" style="margin-top: -100px">
    ...
    <div class="component">
        ...
        <table>
            ...
            <c:forEach items="${accessList}" var="temp" varStatus="st">
                <tr>
                    <td>${temp.access_id}</td>
                    <td>${temp.access_name}</td>
                    <td>${temp.hostname}</td>
                    <td>${temp.port}</td>
                    <td>${temp.db_name}</td>
                    <td>${temp.table} ms</td>
                    ...
                    <td><a href="/access/getAccess.do?accessId=${temp.access_id}">choose</a></td>
                </tr>
            </c:forEach>
